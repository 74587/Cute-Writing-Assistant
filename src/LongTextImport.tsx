...
要求：
1. 人物：提取人物姓名、外貌特征、性格特点、背景故事、人际关系、能力特长等
2. 世界观：提取世界背景、历史、规则、势力分布、地理环境等
3. 剧情：提取重要事件、冲突、转折点、伏笔等
4. 设定：提取特殊能力体系、道具、术语、组织机构等

请尽可能详细地描述每个条目，content 字段至少100字以上。
关键词要包含人名、地名、术语等便于后续检索的词汇。

返回JSON数组格式：[{"category":"人物|世界观|剧情|设定|其他","title":"名称","keywords":["关键词1","关键词2"],"content":"详细描述（至少100字）"}]
